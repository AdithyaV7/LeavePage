...
<head>
    ...
    <title>MA Dashboard - HOD Processing</title>
            ...
            <section class="content">
                <div class="container-fluid">
                    <div class="d-flex justify-content-between align-items-center mb-4">
                        <div>
                            <h2 class="mb-0 fw-bold">Application Review - HOD Processing</h2>
                    ...
                    <div class="alert alert-info mt-4">
                        <i class="fas fa-eye"></i> This application is currently being processed by HOD. You have read-only access.
                    </div>
                    @endif
                </div>
            </section>
